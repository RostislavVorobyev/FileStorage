...
SELECT *, REPLACE ([HumanResources].[Employee].[LoginId], 'adventure-works', 'adventure-works2017') 
...
SELECT[emp].[BusinessEntityID], (emp.VacationHours + emp.SickLeaveHours) 'Sum'
